...
const ar: DashboardDict = {
  ...
  homeTitle: "شو بدك تكتب؟",
  homeSubtitle: "دوّر على أفكار، قلّد بوست، اكتب مسودة، أو قيّم كتابتك.",
  ...
  deleteChat: "حذف",
  inputPlaceholder: "دوّر على أفكار، قلّد بوست، اكتب مسودة…",
  modelLabel: "Claude Sonnet 4.6",
  errorPrefix: "خطأ",
  ...
  learnCoachTitle: "شو خطوتك الجاي",
  learnCoachSubtitle: "بنحلّل منشوراتك ونقارنها بأفضل صنّاع المحتوى، وبنقلك بالظبط شو تغيّر",
  ...
  learnAddSubtitle: "نشرت شي توّك؟ الصق الرابط والنص هون، رح يطلع في التحليلات وندخّله في التقرير الجاي.",
